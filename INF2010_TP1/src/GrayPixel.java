...
public class GrayPixel  extends AbstractPixel 
{
	...
	{
		return new BWPixel(pixel > HALF_VALUE_SEPARATION);
	}
	...
	{
		return new TransparentPixel(new int[]{pixel, pixel, pixel, MAX_COLOR_VALUE});
	}
	...
	{
		return new GrayPixel(MAX_COLOR_VALUE - pixel);
	}
